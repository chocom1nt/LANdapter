...
**Языки:** [English](INSTALL.md) · [Русский](INSTALL-RU.md) · [中文](INSTALL-ZH.md) · [日本語](INSTALL-JA.md) · [Español](INSTALL-ES.md)

В этом руководстве описаны шаги по установке и запуску LANdapter в среде разработки или для тестирования. Для production-развертывания см. [DEPLOY-RU.md](DEPLOY-RU.md).
...
- Изучите [документацию API](README.API-RU.md) для работы с эндпоинтами.
- Настройте [конфигурацию](CONFIG-RU.md) под ваши нужды.
- Для развертывания в продакшн обратитесь к [руководству по развертыванию](DEPLOY-RU.md).